  ...
  return (
    <div className="h-screen w-full flex justify-center items-center">
      <div className="flex bg-opacity-20 mx-auto p-10 rounded-lg space-x-4">
        ...
        >
          <input
            className="p-3 font-medium text-sm outline-1 outline-zinc-400 flex items-center bg-gray-300 bg-opacity-20 rounded-md border border-gray-300 col-span-12 relative"
            type="text"
            id="FirstName"
